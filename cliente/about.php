...
<head>
  <title>DuranStyle - Acerca de</title>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />

  <link rel="apple-touch-icon" href="assets/img/apple-icon.png" />
  <link rel="shortcut icon" type="image/x-icon" href="assets/img/acerca.svg" />
...
<body>
      ...
      <div class="w-100 d-flex justify-content-between">
        <div>
          ...
          <a class="navbar-sm-brand text-light text-decoration-none"
            href="mailto:info@company.com">alanxtn@gmail.com</a>
  ...
  <nav class="navbar navbar-expand-lg navbar-light shadow">
    <div class="container d-flex justify-content-between align-items-center">
      <a class="navbar-brand text-success logo h1 align-self-center" href="panel_cliente.php">
        DuranStyle
      </a>
      ...
      <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between"
        ...
        <div class="flex-fill">
          <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
            <li class="nav-item">
              <a class="nav-link" href="panel_cliente.php">Inicio</a>
            </li>
            <li class="nav-item">
        ...
        <div class="navbar align-self-center d-flex">
          ...
          <form action="" method="post" class="nav-icon position-relative text-decoration-none">
            <i class="fa fa-fw fa-user text-dark mr-3"></i>
            <button type="submit" name="logout" style="border: none; background-color: transparent; cursor: pointer;">
                Cerrar sesión
            </button>
    ...
    <div class="container">
      <div class="row align-items-center py-5">
        <div class="col-md-8 text-white">
          ...
          <p>
            DuranStyle Shop es una tienda web fundada por un estudiante
            apasionado por la moda urbana y la tecnología. Ubicada en la
            hermosa ciudad de Durango, México, nuestra tienda ofrece una
            amplia gama de productos para los amantes de la cultura urbana y
  ...
  <section class="container py-5">
    <div class="row text-center pt-5 pb-3">
      <div class="col-lg-6 m-auto">
        ...
        <p>
          Nos comprometemos por el bien de nuestros clientes a cumplir con los
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-3 pb-5">
        <div class="h-100 py-5 services-icon-wap shadow">
          ...
          <h2 class="h5 mt-4 text-center">Ventas y devoluciones</h2>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3 pb-5">
        <div class="h-100 py-5 services-icon-wap shadow">
          ...
          <h2 class="h5 mt-4 text-center">Promociones y descuentos</h2>
        </div>
      </div>
  ...
  <section class="bg-light py-5">
    <div class="container my-4">
      <div class="row text-center py-3">
        <div class="col-lg-6 m-auto">
          <h1 class="h1">Marcas afiliadas</h1>
          <p>Tenemos acuerdos con las siguientes marcas</p>
        </div>
                  ...
                  <div class="carousel-item active">
                    <div class="row">
                      <div class="col-3 p-md-5">
                        <a href="#"><img class="img-fluid brand-img" src="assets/img/nintendo.png"
                            alt="Brand Logo" /></a>
                      </div>
                      <div class="col-3 p-md-5">
                      ...
                      <div class="col-3 p-md-5">
                        <a href="#"><img class="img-fluid brand-img" src="assets/img/nb.png" alt="Brand Logo" /></a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 pt-5">
          ...
          <ul class="list-unstyled text-light footer-link-list">
            <li><a class="text-decoration-none" href="panel_cliente.php">Inicio</a></li>
