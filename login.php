...
$sql = "SELECT correo, contrasena, es_administrador FROM ultima WHERE correo = ? AND contrasena = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("ss", $correo, $contrasena);
$stmt->execute();
$stmt->bind_result($correo_from_database, $contrasena_from_database, $es_administrador);

if ($stmt->fetch() && $correo_from_database === $correo && $contrasena_from_database === $contrasena) {
  ...
  if ($es_administrador == 1) {
    header("Location: cliente/panel_admin.php");
  } else {
...
<body>
    ...
    <div class="container text-light">
      <div class="w-100 d-flex justify-content-between">
        <div>
          ...
          <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:alanxtn@gmail.com">alanxtn@gmail.com</a>
          <i class="fa fa-phone mx-2"></i>
          <a class="navbar-sm-brand text-light text-decoration-none" href="tel:618-310-89-44">618-310-89-44</a>
        </div>
        <div>
          <a class="text-light" href="https://www.facebook.com/Sal4z4r" target="_blank" rel="sponsored"><i class="fab fa-facebook-f fa-sm fa-fw me-2"></i></a>
          <a class="text-light" href="https://www.instagram.com/if_braandd/" target="_blank"><i class="fab fa-instagram fa-sm fa-fw me-2"></i></a>
          <a class="text-light" href="https://www.tiktok.com/@if_braandd" target="_blank"><i class="fab fa-tiktok fa-sm fa-fw me-2"></i></a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <div class="login-container">
    <form action="login.php" method="post">
      ...
      <input type="text" id="correo" name="correo" placeholder="12345@gmail.com" required>

      <label for="contrasena">Contraseña:</label>
      <input type="password" id="contrasena" name="contrasena" placeholder="lorem12345" minlength="8" maxlength="16" required>

      <span class="sub">No tienes una cuenta? <a href="register.php">Registrate</a></span>
